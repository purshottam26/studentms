...
$id = intval($_GET['id']);
$q = mysqli_query($conn, "SELECT * FROM teachers WHERE id=$id");
...
<head>
<meta charset="UTF-8">
<title>Teacher ID Card - <?php echo $teacher['name']; ?></title>
...
<div class="no-print" style="padding:20px;max-width:500px;margin:0 auto;">
    <div style="display:flex;gap:12px;margin-bottom:10px;">
        ...
        <a href="add_teacher.php" style="padding:10px 20px;background:#e2e8f0;color:#1e293b;border-radius:8px;text-decoration:none;font-size:14px;font-weight:700;">← Back to Teachers</a>
    </div>
</div>
    ...
    <div class="id-card">
        ...
        <div class="id-photo-area">
            <div class="id-photo">
                ...
                <img src="uploads/<?php echo htmlspecialchars($teacher['photo']); ?>" style="width:100%;height:100%;object-fit:cover;">
                <?php else: ?>
                👩‍🏫
                <?php endif; ?>
            </div>
        ...
        <div class="id-body">
            ...
            <div class="id-details">
                ...
                <div class="id-row"><label>Email</label><span style="font-size:11px;"><?php echo htmlspecialchars($teacher['email']); ?></span></div>
    ...
    <div class="id-card back-card">
        ...
        <div class="id-body" style="padding-top:18px;text-align:left;">
            ...
            <div class="back-info">
                ...
                <div class="info-row"><span>Subject</span><strong><?php echo htmlspecialchars($teacher['subject'] ?: 'N/A'); ?></strong></div>
