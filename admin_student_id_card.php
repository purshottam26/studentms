...
.id-photo { width:90px; height:110px; border-radius:12px; border:4px solid white; background:#e2e8f0; display:flex; align-items:center; justify-content:center; font-size:40px; box-shadow:0 8px 20px rgba(0,0,0,0.2); overflow:hidden; }
...
<div class="no-print" style="padding:20px;max-width:500px;margin:0 auto;">
    <div style="display:flex;gap:12px;margin-bottom:10px;">
        ...
        <a href="students_list.php" style="padding:10px 20px;background:#e2e8f0;color:#1e293b;border-radius:8px;text-decoration:none;font-size:14px;font-weight:700;">← Back to Students</a>
    </div>
</div>
...
<div class="id-card-wrapper">
    <div class="id-card">
        ...
        <div class="id-body">
            ...
            <div>
                ...
                <div class="id-row"><label>Mobile</label><span><?php echo htmlspecialchars($student['mobile']); ?></span></div>
                <div class="id-row"><label>Aadhaar</label><span><?php echo htmlspecialchars($student['aadhaar']); ?></span></div>
    ...
    <div class="id-card back-card">
        <div class="id-header">
            ...
            <p>Contact & Emergency Details</p>
        </div>
        <div class="id-body" style="padding-top:18px;text-align:left;">
            <div class="back-title">Student Details</div>
            <div class="back-info">
                <div class="info-row"><span>Student ID</span><strong><?php echo htmlspecialchars($student['student_id']); ?></strong></div>
                <div class="info-row"><span>Course</span><strong><?php echo htmlspecialchars($student['course'] ?: 'N/A'); ?></strong></div>
                <div class="info-row"><span>Email</span><strong><?php echo htmlspecialchars($student['email'] ?? 'N/A'); ?></strong></div>
                <div class="info-row"><span>Mobile</span><strong><?php echo htmlspecialchars($student['mobile'] ?? 'N/A'); ?></strong></div>
            ...
            <p class="back-text">Yeh identity card sirf authorised use ke liye hai. Har roz school aane se pehle apne documents check karen.</p>
