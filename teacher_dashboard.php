    ...
    <div class="content">
        ...
        <div class="dashboard">
            <div class="card">
                ...
                <h3>Teacher ID</h3>
                <p style="font-size:18px;"><?php echo $teacher['teacher_id']; ?></p>
            </div>
            <div class="card">
                <div class="card-icon cyan">📖</div>
                <h3>Subject</h3>
                <p style="font-size:18px;"><?php echo htmlspecialchars($teacher['subject']); ?></p>
            </div>
            <div class="card">
                <div class="card-icon green">📧</div>
                <h3>Email</h3>
                <p style="font-size:14px;"><?php echo htmlspecialchars($teacher['email']); ?></p>
            </div>
        </div>
        <div class="box">
            <div class="box-title">⚡ Quick Actions</div>
            <div style="display:flex;gap:12px;flex-wrap:wrap;">
                <a href="teacher_id_card.php" class="btn btn-primary">🪪 View My ID Card</a>
                <a href="library.php" class="btn btn-success">📚 Library Management</a>
            </div>
        </div>
    </div>
</div>
